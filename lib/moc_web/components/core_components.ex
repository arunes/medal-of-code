defmodule MocWeb.CoreComponents do
  ...
  use Gettext, backend: MocWeb.Gettext
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    ~H"""
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-gray-600 dark:text-white">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MocWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MocWeb.Gettext, "errors", msg, opts)
    end
  end
