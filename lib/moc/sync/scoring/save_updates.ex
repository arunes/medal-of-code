defmodule Moc.Sync.Scoring.SaveUpdates do
  ...
  @spec run(list(Type.medal_winner()), list(Schema.ContributorOverview)) :: :ok
  def run(medal_winners, contributors_before) do
  ...
  defp insert_updates(updates) do
    ...
    Repo.insert_all(Schema.Update, to_insert)
  end
