defmodule Moc.Tests.Counters.SamePRVotedAtLeast10TimesTest do
  use ExUnit.Case
  alias Moc.Scoring.Counters.SamePRVotedAtLeast10Times
  ...
  test "returns an empty list when there are no comments" do
    ...
    assert SamePRVotedAtLeast10Times.count(input, nil) == []
  end
  ...
  test "returns an empty list when a user hasn't voted at least 10 times" do
    comments = [
  ...
  test "returns a contributor with a count of 1 when a user has voted at least 10 times" do
    comments = [
      %{comment_type: :system, content: "voted 10", created_by_id: 1},
      %{comment_type: :system, content: "voted 5", created_by_id: 1},
      %{comment_type: :system, content: "voted -5", created_by_id: 1},
  ...
  test "returns multiple contributors with a count of 1 when multiple users have voted at least 10 times" do
    comments = [
      %{comment_type: :system, content: "voted 10", created_by_id: 1},
      %{comment_type: :system, content: "voted 5", created_by_id: 1},
      %{comment_type: :system, content: "voted -5", created_by_id: 1},
